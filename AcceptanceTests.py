...
class TestApp(TestCase):
    ...
    def test_login_to_database(self):
        ...
        result1 = self.a.command("login BadUser testPassword")
        result2 = self.a.command("login testUsername BadPass")
        result3 = self.a.command("login testUsername testPassword")
        # Error cases
    ...
    def test_add_user(self):
        self.a.command("login brokenUsername brokenPassword")
        result1 = self.a.command("add_user newUsername newPassword")
        self.a.command("logout")
        self.a.command("login testUsername testPassword")
    ...
    def test_change_contact_info(self):
        result = self.a.command("change_contact_info testUser.username SAUCE")
        # Error cases
